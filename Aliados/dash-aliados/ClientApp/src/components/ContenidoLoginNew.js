...
const ContenidoLoginNew = ({  datosMandados, setDatosMandados }) => {
  ...
  const onSubmit = async (formData) => {
    setIsLoading(true);
    const { UsuarioCuit, Clave } = formData;
                ...
                <Button
                  ...
                  onClick={() => {
                    if (usuario && password) {
                      ...
                      onSubmit(); // Realizar la acción de inicio de sesión
                    } else {
...
export default ContenidoLoginNew;

          ...
          >
            ...
            <div>
              ...
              <div className="d-flex justify-content-between flex-wrap mx-2">
                <div className="lato-regular fs-14">Base imponible</div>
                              <div className="lato-bold fs-14"> $ {valoresFormateados[0]}</div>
              </div>
              <div className="d-flex justify-content-between flex-wrap  mx-2">
                <div className="lato-regular fs-14">IVA Débito fiscal</div>
                              <div className="lato-bold fs-14">   $ {valoresFormateados[1]}</div>
              </div>
              <div className="d-flex justify-content-between  flex-wrap  mx-2  ">
            ...
            <div className="text-center">
              <div>
                ...
                <div className="d-flex justify-content-between flex-wrap mx-2">
                  <div className="lato-regular fs-14">Base imponible</div>
                                  <div className="lato-bold fs-14">   $ {valoresFormateados[2]}</div>
                </div>
                <div className="d-flex justify-content-between flex-wrap mx-2">
                  <div className="lato-regular fs-14">IVA Débito fiscal</div>
                                  <div className="lato-bold fs-14"> $ {valoresFormateados[3]}</div>
                </div>
                <div className="d-flex justify-content-between flex-wrap mx-2">

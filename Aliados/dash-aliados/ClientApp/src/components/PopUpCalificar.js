    ...
    <div>
      {/* <div className="">
        <FontAwesomeIcon
          className={
            visible1
              ? "iconos-modales text-dark mx-3"
              : "iconos-modales cursor-point  mx-3 "
          }
                  ...
                  <div className="">
                    <div className=" ">
                      ...
                      <h6 className=" fs-16-a-14">
                        ...
                        <br />
                        ¿qué tan probable es que recomiendes Zoco - Servicios{" "}
                        <br /> de pago a otras personas?
                      </h6>
                      <div className="d-flex justify-content-center" >
                        <form className="width-personalizado-form-popup"  onSubmit={handleSubmit(onSubmit)}>
